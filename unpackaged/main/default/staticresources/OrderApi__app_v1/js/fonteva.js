...
/**
 * Scripts for setting up page styles.
 * @Namespace	fonteva.ui
 */
fonteva.ui 	=  	{};
(function() {
	this.replaceLookupIcons = function() {
		var result = false;
		if( $( ".lookupIcon" ).length ) {
			$( ".lookupIcon" ).parent().html( "<i class=\"lookup-icon icon icon-search\"> </i>" );
			result = true;
		}
		else {
			result = false;
...
/**
 * @tableNav()
 * @arg: table 							The selector for the table to paginate
 * @arg: childSelector 	 		jQuery selector for the table rows to paginate
 * @arg: paginationSelector	jQuery selector for the pagination selector
 */
// (function() {
//   (function($) {
...
// 	        options.paginationSelector = (_ref1 = opts.pagination) != null ? _ref1 : options.table.siblings('.aui-pager');
